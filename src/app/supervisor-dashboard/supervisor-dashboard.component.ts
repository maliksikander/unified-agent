...
export class SupervisorDashboardComponent implements OnInit {
  ...
  queueStatsData = [
    {
      sr: 1, queue: 'Marketing', count: '6', maxTime: '01:06:22', active: 'web', busy: '8', ready: '7', not_ready: '13',
      labels: [
    ...
    {
      sr: 2, queue: 'Inbound', count: '16', maxTime: '01:22:22', active: 'web', busy: '4', ready: '6', not_ready: '2',
      labels: [
        {name: 'label 1', count: 6, maxTime: '01:06:22'},
        {name: 'label 2', count: 5, maxTime: '01:06:22'}
      ],
    ...
    {
      sr: 3, queue: 'OutBoaund', count: '8', maxTime: '00:35:42', active: 'web', busy: '5', ready: '4', not_ready: '8',
      labels: [
        {name: 'label 1', count: 6, maxTime: '01:06:22'},
        {name: 'label 2', count: 5, maxTime: '01:06:22'},
    ...
    {
      sr: 4, queue: 'Product Support', count: '5', maxTime: '01:15:52', active: 'web', busy: '9', ready: '8', not_ready: '6',
      labels: [
    ...
    {
      sr: 5, queue: 'Product Information', count: '7', maxTime: '01:26:32', active: 'web', busy: '12', ready: '5', not_ready: '9',
      labels: [
        {name: 'test', count: 6, maxTime: '01:06:22'},
        {name: 'test', count: 6, maxTime: '01:06:22'}
      ],
    ...
    {
      sr: 6, queue: 'Channel Marketing', count: '9', maxTime: '01:36:12', active: 'web', busy: '4', ready: '3', not_ready: '2',
      labels: [
        {name: 'test', count: 6, maxTime: '01:06:22'},
        {name: 'test', count: 6, maxTime: '01:06:22'}
      ],
