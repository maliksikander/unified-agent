      ...
      return this._httpClient
        ...
        .then((e: any) => {
          ...
          config = {
            ...
            isGadget: e.isGadget,
            adminUsername:
              e.ctiParam && typeof e.ctiParam == "string" ? CryptoJS.AES.decrypt(e.ctiParam, this.passphrase).toString(CryptoJS.enc.Utf8) : null,
            adminPassword:
              e.ctiParam2 && typeof e.ctiParam2 == "string" ? CryptoJS.AES.decrypt(e.ctiParam2, this.passphrase).toString(CryptoJS.enc.Utf8) : null
          };
          ...
          sipConfig = {
            ...
            uri: e.SIP_URI,
            agentStaticPassword:
              e.EXT_STATIC && typeof e.EXT_STATIC == "string"
                ? JSON.parse(CryptoJS.AES.decrypt(e.EXT_STATIC, this.passphrase).toString(CryptoJS.enc.Utf8))
                : null,
