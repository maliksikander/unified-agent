...
function parseEvent(event) {
  ...
  console.log(event);
  if (!finesseFlavor) finesseFlavor = config.finesseFlavor;
  // console.log("flavor==>", finesseFlavor)
  var parsedEvent;
...
function parseDialogEventType(dialog) {
  try {
    ...
    console.log("finesseFlavor==>", finesseFlavor)
    console.error("[parseDialogEventType] Error ==>", err);
  }
}
